...
export function Footer() {
  ...
  return (
    <footer className="store-footer border-t border-line py-8 px-[4.5%] bg-canvas flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted">
